...
Recent surveys of AI governance frameworks find that abstract principles---fairness, transparency, accountability, human oversight---are now endorsed by governments and corporations worldwide [@jobin2019global]. Professional codes for computing similarly frame the field as a public-interest practice, not merely an engineering one [@acm2018code]. The problem is the gap between principle and practice: principles are easy to endorse and difficult to enforce.
